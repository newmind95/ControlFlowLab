...
* if the number passed is 234, then the reversed number would be 432. The method  reverse should 
* also reverse negative numbers.
...
The method getDigitCount should have one int parameter called number and return 
* the count of the digits in that number. If the number is negative, return -1 
...
* To get the number of zeroes, check the difference between the digit count from the 
