...
If one of the parameters area or areaPerBucket is less or equal to 0, the method needs 
...
public class PaintJobTask {
    ...
    /** Method to calculate the number of buckets. */
    public static double getBucketCount(double width, double height,
        ...
        int totalBuckets = (int) Math.round(getBucketCount(width, height, areaPerBucket) - extraBucket);
        return totalBuckets;
    }
    ...
    public static double getBucketCount(double width, double height, double areaPerBucket) {
        ...
        int totalBuckets = (int) getBucketCount(width * height, areaPerBucket);
        return totalBuckets;
    }
